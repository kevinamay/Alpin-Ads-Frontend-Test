    ...
    <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center bg-black/50" onClick={onClose}>
      ...
      >
        ...
        <div className="relative w-[52%] flex-none bg-black">
          <img src={room.images[currentSlide]} alt={room.name} className="w-full h-full object-cover" />
          <button onClick={prevSlide} className="absolute left-[16px] top-1/2 -translate-y-1/2 w-[40px] h-[40px] flex items-center justify-center bg-white/80 hover:bg-white rounded-full transition-colors text-[#323232]">
            <ArrowLeftIcon />
          </button>
          <button onClick={nextSlide} className="absolute right-[16px] top-1/2 -translate-y-1/2 w-[40px] h-[40px] flex items-center justify-center bg-white/80 hover:bg-white rounded-full transition-colors text-[#323232]">
            <ArrowRightIcon />
          </button>
